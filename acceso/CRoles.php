...
class CRoles extends CUsuario{
 ...
 function getRolesAsignadosByUser($default_select){
 	$sql = "SELECT r.idRol, r.nombreRol from roles r, rol_del_usuario ru, usuarios u Where r.idRol=ru.idRol And ru.idUser=u.idUser And r.idRol>=".$_SESSION['rol_usuario']." And u.idUser=".$this->getIdUsuario()." ORDER BY r.idRol;";
 	echo $sql;
 	$resultado = $this->query($sql); 	
 	if($resultado)
 	{
