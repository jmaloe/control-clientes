...
<html lang="es">
	...
	<body class="todo-contenido">
		...
		<section id="selecion_actividad">
			<form action="FClientes.php" method="POST" accept-charset="UTF-8"
enctype="application/x-www-form-urlencoded" autocomplete="off" novalidate>
			<fieldset>
		  		<legend>Sistema de Control de Clientes <!--a href="../manual/" target="_blank"><img src="../imagenes/manual_usuario.png" width="30" height="30" title="Manual de usuario"></a--></legend>
				<div>¡Bienvenido <?php echo $_SESSION['USERNAME']; echo "!<br>"; echo date('d-m-Y H:i:s');?></div>
				
				<div id="actividad_academica">
					<p>Registro de <b>PAGOS</b></p>				 
				</div>
